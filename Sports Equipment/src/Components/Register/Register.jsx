...
const Register = () => {
  ...
  const { loginGoogle, createUserEmail, userUpdate ,user} = useContext(AuthContext);
//   FOR EMAIL
  ...
  const handleCreate = (e) => {
    ...
    createUserEmail(email,password)
      .then((res) => {
        ...
        const createAt = res?.users?.metadata?.creationTime;
        const newUser = {name,email,createAt}


        fetch('https://server-jade-sigma.vercel.app/users', {
          method: 'POST',
          headers: {
