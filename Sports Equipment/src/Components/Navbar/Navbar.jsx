...
function Navbar() {
  ...
  const navbar = [
    { title: "Home", link: "/" },
    { title: "AllSports", link: "allSports" },
    { title: "Add Equipment", link: "addEquipment" },
    { title: "My Equipment", link: "myEquipment" },
  ...
  return (
    <div
      className={`navbarMain sticky top-0 py-4 lg:py-0 items-center z-50 px-4 text-yellow-200 ${
        darkMode ? "dark-mode" : "bg-gray-900"
      }`}
    >
