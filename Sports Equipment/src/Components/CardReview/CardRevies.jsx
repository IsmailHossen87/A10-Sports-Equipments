...
const CardReview = () => {
  ...
  const getAllReview = async () => {
    try {
      const response = await axios.get(`https://server-jade-sigma.vercel.app/review`);
  ...
  return (
    <div className="my-4">
      ...
      <div className="my-6 text-center px-5 mx-auto">
        <h3 className="text-3xl font-bold my-2">What Our Athletes Say</h3>
        <p>Stories from passionate athletes and fitness enthusiasts</p>
      </div>
